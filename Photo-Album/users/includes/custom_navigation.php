<?php // require_once 'users/album/init.php'; ?>
...
<div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	<div class="container">
		...
		<div class="navbar-header ">
			...
			<a class="" href="<?=$us_url_root?>"><img class="img-responsive" src="<?=$us_url_root?>users/images/camera_logo.png" alt="" /></a>
		</div>
...
$x = $query->results(true);
            ...
            ?>
                    ...
                    <li><a href="<?=$us_url_root?>users/album/upload_pics.php" ><i class="fa fa-fw fa-upload"></i> <?php echo "Upload Pictures";?></a></li> <!-- Common for Hamburger and Regular menus link -->
 ...
 $user_no_info = $user->data()->id;  //getting user no  
